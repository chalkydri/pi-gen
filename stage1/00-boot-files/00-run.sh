...
install -m 644 files/userconf.txt "${ROOTFS_DIR}/boot/firmware/"
install -m 644 files/ssh.txt "${ROOTFS_DIR}/boot/firmware/"

for file in cmdline.txt config.txt ssh.txt userconf.txt; do
